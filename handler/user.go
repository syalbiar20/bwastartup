...
func (h *userHandler) CheckEmailAvailability(c *gin.Context) {
	...
	// service akan manggil repository untuk menentukan apakah - email sudah terdaftar atau belum
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	...
	// repo ambil data user yg ID = 1 / x
	...
	//harusnya dapat dari JWT, tapi belum belajar mengenai JWT
	userID := 1
	...
	response := helper.APIResponse("Avatas successfuly uploaded", http.StatusOK, "success", data)
